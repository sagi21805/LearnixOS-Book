...
Just make sure you know this stuff or learn it as you read. Also, if in any place of this book I take some things for granted, please, [open an issue](https://github.com/sagi21805/LearnixOS-Book) and let me know so I can explain it better.
...
- Knowledge in Rust is not _that_ important, but knowing at least one programming language is. I myself have some more learning in Rust, and in this book I will also explain some great features that it has! 

- A lot of motivation to learn and understand because it is a complex subject.

## Roadmap of this book

01. Compiling a standalone binary
...
09. Running our first program! (Which of course will be Doom)

10. To be continued (Hopefully a virtualization section and loading a VM of another OS)
